...
namespace Brunoinds\SunatDolarLaravel\Store;
...
class StoreLaravelCache
{
    ...
    public function get()
    {
        return Cache::store($this->store)->get('Brunoinds/SunatDolarLaravelStore');
    }

    public function set(string $value)
    {
        Cache::store($this->store)->put('Brunoinds/SunatDolarLaravelStore', $value);
    }
}